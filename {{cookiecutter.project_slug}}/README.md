...
If you want to use poetry, you can skip this step
...
#### Initialize the project (need poetry 1.0.10 or higher)

- `poetry install` - create a project, initialize the virtualenv, and install dependencies
- `poetry install --dev molecule docker` - add development dependencies to the project (optionnal)
...
---
rails_version: 5.0.0
rails_secret_token: {% raw %}"{{ secret_rails_secret_token }}"{% endraw %}
```
